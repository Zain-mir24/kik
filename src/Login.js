...
function Login() {
    ...
    return (
         <div>
            ...
            <input style={inputstyling}  type="username" placeholder="EnterYourusername" onChange={(e)=>setname(e.target.value)} />
            <input style={inputstyling} type="text" placeholder="Enter the room you wanna enter" onChange={(e)=>setRoom(e.target.value)} />
